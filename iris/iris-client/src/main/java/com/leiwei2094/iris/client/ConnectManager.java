...
import com.leiwei2094.coco.ExtensionLoader;
import com.leiwei2094.iris.core.Endpoint;
import com.leiwei2094.iris.core.IrisConfig;
import com.leiwei2094.iris.core.loadbalance.ILoadBalance;
import com.leiwei2094.iris.registry.IEventCallback;
import com.leiwei2094.iris.registry.IRegistry;
import com.leiwei2094.iris.registry.RegistryEvent;
...
public class ConnectManager implements IConnectManager,IEventCallback{
    ...
    public void execute(RegistryEvent event) {
        if (event.getEventType() == RegistryEvent.EventType.DELETE){
            ...
            // key:   /iris/com.leiwei2094.iris.bytebuddy.IHelloService/192.168.41.215:2017

            String s = event.getKeyValue().getKey();
            String serviceName = s.split("/")[2];             // com.leiwei2094.iris.bytebuddy.IHelloService
